            ...
            <div class="table-responsive">        
                <table class="table table-hover  table-striped table-bordered border-danger table-sm" id="book">
                    ...
                    foreach($result as $book ){
                        ...
                        echo '<td>
                        <button type="button" class="btn m-2 btn-success" onclick="editCover(\''.$book['ISBN'].'\')"><i class="fa-solid fa-image"></i></button>
                        <button type="button" class="btn m-2 btn-warning" onclick="editBook(\''.$book['ISBN'].'\')"><i class="fa-solid fa-pen-to-square"></i></button>
                        <button type="button" class="btn m-2 btn-danger"  onclick="deleteBook(\''.$book['ISBN'].'\')" ><i class="fa-solid fa-trash"></i></button>
                        </td>';
                        echo '</tr>';
                    }
                    ?>
